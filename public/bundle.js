...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="position-right">
            <li><a href="https://twitter.com/${window.variables.twitter}"><i class="fa fa-twitter"></i></a></li>
            <li><a href="https://github.com/${window.variables.github}"><i class="fa fa-github"></i></a></li>
            <li><a href="https://linkedin.com/${window.variables.linkedin}"><i class="fa fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${window.variables.instagram}"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
